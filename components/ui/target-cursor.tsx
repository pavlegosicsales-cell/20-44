...
export default function TargetCursor({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      const cursorX = num(gsap.getProperty(cursorRef.current, "x") as number);
      const cursorY = num(gsap.getProperty(cursorRef.current, "y") as number);
    ...
    const scrollHandler = () => {
      ...
      const mouseX = num(gsap.getProperty(cursorRef.current, "x") as number) + offsetX;
      const mouseY = num(gsap.getProperty(cursorRef.current, "y") as number) + offsetY;
      ...
      const leaveHandler = () => {
        ...
        resumeTimeout = setTimeout(() => {
          if (!activeTarget && cursorRef.current && spinTl.current) {
            const currentRotation = num(gsap.getProperty(cursorRef.current, "rotation") as number);
